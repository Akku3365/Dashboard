...
//             setEditTasks(null);
//         } else {
//             let temp_arr = [...taskList, { ...tasks, id: Date.now(), status: "Task List" }];
...
//             const taskId = taskList[sourceIndex].id;
//             const newStatus =
//                 destinationListId === "in-process" ? "In Process" : "Completed";
...
//                                     <TaskList taskList={taskList.filter((task) => task.status === "Task List")} role={role} taskEditFunction={taskEditFunction} taskInputDelete={taskInputDelete} openModal={openModal} />
